...
public class Thealth extends Application {
    public static final String TAG = Thealth.class.getSimpleName();

    private String m_gsmToken = "";

    private static final String LOG_TAG = "CrashCatch";

    private static Thealth _instance;

    public static Thealth getApplication() {
        return _instance;
    }
    ...
    public static synchronized Thealth getInstance(){
        return _instance;
    }
